...
// 衝突処理
void CPlayerBace::Collision(CCollider* self, CCollider* other, const CHitInfo& hit)
{
	// 本体のコライダーの衝突判定
	if (self == mpBodyCol)
	{
...
// アニメーション切り替え
void CPlayerBace::ChangeAnimation(int type, bool restart)
{
