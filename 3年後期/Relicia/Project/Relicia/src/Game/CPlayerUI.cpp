...
// 最大値を設定
void CPlayerUI::SetMaxPoint(int point)
{
	mMaxPoint = point;
	ApplyPoint();
}
...
// 現在値を設定
void CPlayerUI::SetCurPoint(int point)
{
	mCurPoint = point;
	ApplyPoint();
}
...
// バーの色(白)
CColor CPlayerUI::CalcBarColor() const
{
	// バーの色を設定
