...
namespace Crystal
{
	...
	const std::map<ElementType, CrystalData> CRYSTAL_DATA =
	{
		// 炎のクリスタル
		{
			ElementType::Fire,
			{
				...
				"Crystal_3_AlbedoTransparency.png"
			}
		},
		// 水のクリスタル
		{
			ElementType::Water,
			{
				...
				"Crystal_1_AlbedoTransparency.png"
			}
		},
		// 雷のクリスタル
		{
			ElementType::Thunder,
			{
				...
				"Crystal_4_AlbedoTransparency.png"
			}
		},
		// 風のクリスタル
		{
			...
			{
				ElementType::Wind,
				ICON_PATH"wind_icon.png",
				"Crystal_2_AlbedoTransparency.png"
			}
		},
	...
	//		CResourceManager::Load<CModel>(data->texPath, data->texPath, true);
	//	}
	...
	//		CResourceManager::Delete(data->texPath);
	//	}
